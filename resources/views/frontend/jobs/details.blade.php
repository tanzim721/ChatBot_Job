...
@section('title', 'Jobbar' . ' : ' . $job->company_name)
        ...
        <header class="relative pt-8 overflow-hidden isolate">
          ...
          ">
            ...
            <div class="px-4 py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex items-center justify-between max-w-2xl mx-auto lg:mx-0 lg:max-w-none">
                    <a href="{{ route('job') }}" type="button"
                ...
                <div class="flex items-center justify-between max-w-2xl mx-auto gap-x-8 lg:mx-0 lg:max-w-none">
                    <div class="flex flex-col items-start md:flex-row gap-x-6">
                        ...
                        <h1>
                            ...
                            <div class="mt-1 text-xl font-semibold leading-6 md:text-2xl text-gray-50">
                                {{ $job->title }}
                            </div>
                        </h1>
                    </div>
                        ...
                        <dl class="flex flex-wrap gap-4 mb-6">
                            ...
                            <div class="flex flex-none w-full gap-x-4">
                                <dt class="flex-none">
                                    ...
                                    <svg class="w-5 h-6 text-gray-400" viewBox="0 0 20 20" fill="currentColor"
                                        aria-hidden="true">
                                        <path
                                ...
                                <dd class="text-sm leading-6 text-gray-300">
                                    <time datetime="{{ \Carbon\Carbon::parse($job->created_at)->format('Y-m-d') }}">{{ \Carbon\Carbon::parse($job->created_at)->formatLocalized('%B %d, %Y') }}</time>
                                </dd>
                            </div>
                        </dl>
